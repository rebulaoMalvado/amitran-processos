// Ícones lucide inline — mesmos paths do protótipo.
const PATHS: Record<string, string> = {
  ...
  wallet:
    '<path d="M19 5H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Z"/><path d="M16 12h.01M3 10h18"/>',
